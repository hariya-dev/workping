  ...
  template: `
    <div class="min-h-screen bg-gray-50">
      ...
      <aside 
        ...
        <!-- Logo -->
        <div class="flex items-center justify-center h-20 bg-white border-b border-gray-200 px-4">
          <img
            src="https://atpro.com.vn/wp-content/uploads/2025/12/logo-tet-2026.png"
            alt="An Tường Technology"
            class="h-12 w-auto object-contain"
            onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
          <span class="hidden text-xl font-bold text-gray-800">HR System</span>
        </div>
